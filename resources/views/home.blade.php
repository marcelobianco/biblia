            ...
            <div class="col-md-3 mb-4">
                ...
                <div class="d-flex flex-column">
                    @foreach ($testamentos->find(1)?->livros as $antigoTestamento)
                        <a href="{{ route('capitulos', [$antigoTestamento->versao->abreviacao, $antigoTestamento->abreviacao]) }}" class="tema-link">{{ $antigoTestamento->nome }}</a>
                    @endforeach
                </div>
            </div>
            ...
            <div class="col-md-3 mb-4">
                ...
                <div class="d-flex flex-column">
                    @foreach ($testamentos->find(2)?->livros as $novoTestamento)
                        <a href="{{ route('capitulos', [$antigoTestamento->versao->abreviacao, $antigoTestamento->abreviacao]) }}" class="tema-link">{{ $novoTestamento->nome }}</a>
                    @endforeach
                </div>
            </div>
        </div>
